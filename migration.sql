...
('Rondelles M4', 60),
('Rondelles M6', 60),
('Vis M4 à tête hexagonale', 50),
('Vis M6 à tête hexagonale', 50),
('Colliers de serrage', 30),
('Joints toriques', 20),
('Joints plats', 20),
('Connecteurs électriques', 10),
('Câbles électriques', 15),
('Fusibles', 20),
('Ruban adhésif technique', 8),
('Fil métallique', 10),
('Plaques aluminium de réparation', 6),
('Insert filetés', 15),
('Rivets', 40),
('Ressorts de rechange', 15);
